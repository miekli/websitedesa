...
// Mengambil data dari tabel tb_november
$query = mysqli_query($conn, "SELECT * FROM tb_november");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: November ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, November <?php echo $year; ?></p>
