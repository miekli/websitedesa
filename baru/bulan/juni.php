...
// Mengambil data dari tabel tb_juni
$query = mysqli_query($conn, "SELECT * FROM tb_juni");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Juni ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Juni <?php echo $year; ?></p>
