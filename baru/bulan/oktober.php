...
// Mengambil data dari tabel tb_oktober
$query = mysqli_query($conn, "SELECT * FROM tb_oktober");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Oktober ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Oktober <?php echo $year; ?></p>
