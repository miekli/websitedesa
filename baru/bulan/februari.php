...
// Mengambil data dari tabel tb_februari
$query = mysqli_query($conn, "SELECT * FROM tb_februari");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Februari ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Februari <?php echo $year; ?></p>
