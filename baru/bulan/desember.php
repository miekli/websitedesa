...
// Mengambil data dari tabel tb_desember
$query = mysqli_query($conn, "SELECT * FROM tb_desember");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Desember ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Desember <?php echo $year; ?></p>
