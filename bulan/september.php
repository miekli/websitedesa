...
// Mengambil data dari tabel tb_september
$query = mysqli_query($conn, "SELECT * FROM tb_september");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: September ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, September <?php echo $year; ?></p>
