...
// Mengambil data dari tabel tb_april
$query = mysqli_query($conn, "SELECT * FROM tb_april");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: April ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, April <?php echo $year; ?></p>
