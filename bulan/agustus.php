...
// Mengambil data dari tabel tb_agustus
$query = mysqli_query($conn, "SELECT * FROM tb_agustus");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Agustus ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Agustus <?php echo $year; ?></p>
