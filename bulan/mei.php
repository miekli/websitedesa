...
// Mengambil data dari tabel tb_mei
$query = mysqli_query($conn, "SELECT * FROM tb_mei");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Mei ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Mei <?php echo $year; ?></p>
