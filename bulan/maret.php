...
// Mengambil data dari tabel tb_maret
$query = mysqli_query($conn, "SELECT * FROM tb_maret");
$result = [];
...
<body>
    ...
    <div id="attendance-report">
        ...
        <p class="subtitle">Bulan: Maret ; Tahun: <?php echo $year; ?></p>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <p>Sukanegara, Maret <?php echo $year; ?></p>
